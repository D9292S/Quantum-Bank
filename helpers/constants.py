...
STAT_NAMES = {
    "hp": "HP", "atk": "Attack", "defn": "Defense", "satk": "Sp. Atk",
    "sdef": "Sp. Def", "spd": "Speed", "evasion": "Evasion",
    "accuracy": "Accuracy", "crit": "Critical Hit",
}
...
SORTING_FUNCTIONS = {
    "number": "idx", "iv": "iv_total", "level": "level",
    "pokedex": "species_id", "price": "market_data.price",
    "bid": "auction_data.current_bid", "ends": "auction_data.ends",
    "id": "_id",
}
...
FILTER_BY_NUMERICAL = {
    "iv": "iv_total", "level": "level", "hpiv": "iv_hp", "atkiv": "iv_atk",
    "defiv": "iv_defn", "spatkiv": "iv_satk", "spdefiv": "iv_sdef",
    "spdiv": "iv_spd",
}

FILTER_BY_DUPLICATES = {
    "triple": 3, "quadruple": 4, "pentuple": 5, "hextuple": 6,
}

IV_FIELDS = [
    "iv_hp", "iv_atk", "iv_defn", "iv_satk", "iv_sdef", "iv_spd",
]
