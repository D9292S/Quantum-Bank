...
class SelectView(discord.ui.View):
    def __init__(self, ctx, *, options: typing.List[discord.SelectOption], timeout: float, delete_after: bool) -> None:
...
class ConfirmationView(discord.ui.View):
    def __init__(self, ctx, *, timeout: float, delete_after: bool) -> None:
        super().__init__(timeout=timeout)
        self.result = None
        self.ctx = ctx
        self.message: discord.Message | None = None
